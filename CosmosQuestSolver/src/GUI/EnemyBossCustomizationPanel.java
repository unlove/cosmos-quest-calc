...
public class EnemyBossCustomizationPanel extends JPanel{
    ...
    public EnemyBossCustomizationPanel(EnemySelectFrame frame, EnemyFormationMakerPanel enemyFormationMakerPanel, WorldBoss boss){
        this.frame = frame;
        this.enemyFormationMakerPanel = enemyFormationMakerPanel;
        this.boss = boss;
        
        
        picturePanel = new CreaturePictureSelectionPanel(frame,enemyFormationMakerPanel,boss);
