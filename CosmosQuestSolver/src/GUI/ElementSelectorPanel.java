...
public class ElementSelectorPanel extends JPanel{
    ...
    public ElementSelectorPanel(EnemySelectFrame frame,MonsterSelectionPanel monsterSelectionPanel) {
        ...
        airButton = new JButton(new ImageIcon(CreatureFactory.getPicture("Others/Air Symbol")));
        waterButton = new JButton(new ImageIcon(CreatureFactory.getPicture("Others/Water Symbol")));
        earthButton = new JButton(new ImageIcon(CreatureFactory.getPicture("Others/Earth Symbol")));
        fireButton = new JButton(new ImageIcon(CreatureFactory.getPicture("Others/Fire Symbol")));
