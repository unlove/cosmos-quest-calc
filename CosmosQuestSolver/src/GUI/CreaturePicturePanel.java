...
public class CreaturePicturePanel extends JPanel implements MouseListener{//mouse Entering listener for discriptions?
    ...
    public void paintComponent(Graphics g){
        g.drawImage(CreatureFactory.getPicture("Backgrounds/Creature Background"), 0, 0, AssetPanel.CREATURE_PICTURE_SIZE, AssetPanel.CREATURE_PICTURE_SIZE, null);
